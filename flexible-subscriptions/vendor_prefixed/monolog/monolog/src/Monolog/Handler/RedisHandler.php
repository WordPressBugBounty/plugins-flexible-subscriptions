...
class RedisHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($redis instanceof \WPDesk\FlexibleSubscriptions\Vendor\Predis\Client || $redis instanceof \Redis)) {
    ...
    protected function writeCapped(array $record): void
    {
        if ($this->redisClient instanceof \Redis) {
            $mode = defined('WPDesk\FlexibleSubscriptions\Vendor\Redis::MULTI') ? \Redis::MULTI : 1;
