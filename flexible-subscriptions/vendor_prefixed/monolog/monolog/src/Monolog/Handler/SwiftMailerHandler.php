...
use WPDesk\FlexibleSubscriptions\Vendor\Swift_Message;
use WPDesk\FlexibleSubscriptions\Vendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\WPDesk\FlexibleSubscriptions\Vendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
