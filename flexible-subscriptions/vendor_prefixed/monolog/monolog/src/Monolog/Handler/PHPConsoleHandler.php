...
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Formatter\LineFormatter;
...
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Utils;
use WPDesk\FlexibleSubscriptions\Vendor\PhpConsole\Connector;
use WPDesk\FlexibleSubscriptions\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use WPDesk\FlexibleSubscriptions\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('WPDesk\FlexibleSubscriptions\Vendor\PhpConsole\Connector')) {
