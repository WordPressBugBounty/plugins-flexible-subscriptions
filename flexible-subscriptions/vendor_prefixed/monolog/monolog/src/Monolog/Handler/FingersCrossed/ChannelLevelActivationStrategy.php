 ...
 */
namespace WPDesk\FlexibleSubscriptions\Vendor\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('WPDesk\FlexibleSubscriptions\Vendor\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
