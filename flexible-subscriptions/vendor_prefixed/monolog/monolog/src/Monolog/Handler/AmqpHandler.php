...
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Formatter\JsonFormatter;
use WPDesk\FlexibleSubscriptions\Vendor\PhpAmqpLib\Message\AMQPMessage;
use WPDesk\FlexibleSubscriptions\Vendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
