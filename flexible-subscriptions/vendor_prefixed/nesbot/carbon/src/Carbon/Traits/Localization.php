 ...
 */
namespace WPDesk\FlexibleSubscriptions\Vendor\Carbon\Traits;

use WPDesk\FlexibleSubscriptions\Vendor\Carbon\CarbonInterface;
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\Exceptions\InvalidTypeException;
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\Language;
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\Translator;
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use WPDesk\FlexibleSubscriptions\Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use WPDesk\FlexibleSubscriptions\Vendor\Symfony\Component\Translation\TranslatorInterface;
use WPDesk\FlexibleSubscriptions\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use WPDesk\FlexibleSubscriptions\Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('WPDesk\FlexibleSubscriptions\Vendor\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('WPDesk\FlexibleSubscriptions\Vendor\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('WPDesk\FlexibleSubscriptions\Vendor\Symfony\Contracts\Translation\TranslatorInterface', 'WPDesk\FlexibleSubscriptions\Vendor\Symfony\Component\Translation\TranslatorInterface');
}
