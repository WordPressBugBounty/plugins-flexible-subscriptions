...
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\CarbonPeriodImmutable;
use WPDesk\FlexibleSubscriptions\Vendor\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    public function __toString()
    {
        ...
        return $format instanceof Closure ? $format($this) : $this->rawFormat($format ?: (\defined('WPDesk\FlexibleSubscriptions\Vendor\static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : CarbonInterface::DEFAULT_TO_STRING_FORMAT));
    }
    /**
    ...
    {
        return $this->avoidMutation()->setTimezone('GMT')->rawFormat(\defined('WPDesk\FlexibleSubscriptions\Vendor\static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : CarbonInterface::RFC7231_FORMAT);
    }
    /**
