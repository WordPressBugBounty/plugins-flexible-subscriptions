...
namespace WPDesk\FlexibleSubscriptions\Vendor\WPDesk\PluginBuilder\Builder;

use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\PluginBuilder\Plugin\AbstractPlugin;
use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
