...
if (!\interface_exists('WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Has_Plugin_Info')) {
