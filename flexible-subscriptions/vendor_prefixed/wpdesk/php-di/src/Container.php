...
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Helper\DefinitionHelper;
...
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Resolver\DefinitionResolver;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Source\DefinitionArray;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Source\MutableDefinitionSource;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\Source\SourceChain;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Definition\ValueDefinition;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Invoker\DefinitionParameterResolver;
use WPDesk\FlexibleSubscriptions\Vendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\Invoker;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\InvokerInterface;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\ParameterResolver\DefaultValueResolver;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\ParameterResolver\NumericArrayResolver;
use WPDesk\FlexibleSubscriptions\Vendor\Invoker\ParameterResolver\ResolverChain;
