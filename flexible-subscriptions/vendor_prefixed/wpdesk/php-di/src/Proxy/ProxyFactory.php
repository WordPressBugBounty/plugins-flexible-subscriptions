...
namespace WPDesk\FlexibleSubscriptions\Vendor\DI\Proxy;

use WPDesk\FlexibleSubscriptions\Vendor\ProxyManager\Configuration;
use WPDesk\FlexibleSubscriptions\Vendor\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use WPDesk\FlexibleSubscriptions\Vendor\ProxyManager\FileLocator\FileLocator;
use WPDesk\FlexibleSubscriptions\Vendor\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use WPDesk\FlexibleSubscriptions\Vendor\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use WPDesk\FlexibleSubscriptions\Vendor\ProxyManager\Proxy\LazyLoadingInterface;
/**
