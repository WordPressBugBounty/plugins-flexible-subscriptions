...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\value')) {
    /**
...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\create')) {
    /**
...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\autowire')) {
    /**
...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\factory')) {
    /**
...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\decorate')) {
    /**
...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\get')) {
    /**
...
if (!function_exists('WPDesk\FlexibleSubscriptions\Vendor\DI\string')) {
    /**
