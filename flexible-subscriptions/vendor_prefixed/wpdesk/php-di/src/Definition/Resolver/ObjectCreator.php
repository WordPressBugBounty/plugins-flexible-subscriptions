...
use WPDesk\FlexibleSubscriptions\Vendor\DI\DependencyException;
...
class ObjectCreator implements DefinitionResolver
{
    ...
    public static function setPrivatePropertyValue(?string $className, $object, string $propertyName, $propertyValue = null)
    {
