...
if (!\class_exists('WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Tracker_Sender_Logged')) {
    class WPDesk_Tracker_Sender_Logged implements \WPDesk_Tracker_Sender
    {
        ...
        {
            if (\class_exists('WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Logger_Factory')) {
