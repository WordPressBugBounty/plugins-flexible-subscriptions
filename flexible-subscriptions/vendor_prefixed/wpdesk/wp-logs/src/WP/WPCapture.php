...
namespace WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-subscriptions'),
            $dir
        ), \WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-subscriptions'),
            $file
        ), \WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
