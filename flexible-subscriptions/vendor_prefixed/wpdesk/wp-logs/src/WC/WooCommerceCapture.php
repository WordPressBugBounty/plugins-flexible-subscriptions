...
namespace WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WC;

use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Logger;
use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WC\Exception\WCLoggerAlreadyCaptured;
/**
