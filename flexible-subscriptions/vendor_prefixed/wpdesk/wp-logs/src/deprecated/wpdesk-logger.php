...
if (!\class_exists('WPDesk\FlexibleSubscriptions\Vendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-subscriptions'), 'emergency' => \__('Emergency', 'flexible-subscriptions'), 'alert' => \__('Alert', 'flexible-subscriptions'), 'critical' => \__('Critical', 'flexible-subscriptions'), 'error' => \__('Error', 'flexible-subscriptions'), 'warning' => \__('Warning', 'flexible-subscriptions'), 'notice' => \__('Notice', 'flexible-subscriptions'), 'info' => \__('Info', 'flexible-subscriptions'), 'debug' => \__('Debug', 'flexible-subscriptions')];
        }
        /**
         * @param string $level
         * @param string $source
