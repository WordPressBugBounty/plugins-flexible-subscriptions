...
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Handler\FingersCrossedHandler;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Handler\HandlerInterface;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Logger;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Handler\ErrorLogHandler;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Processor\PsrLogMessageProcessor;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Processor\UidProcessor;
use WPDesk\FlexibleSubscriptions\Vendor\Psr\Log\LogLevel;
use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WC\WooCommerceHandler;
