...
use LogicException;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Handler\NullHandler;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Logger;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Registry;
use WPDesk\FlexibleSubscriptions\Vendor\Monolog\Handler\StreamHandler;
use WPDesk\FlexibleSubscriptions\Vendor\Psr\Log\LogLevel;
use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WC\WooCommerceCapture;
use WPDesk\FlexibleSubscriptions\Vendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('WPDesk\FlexibleSubscriptions\Vendor\WC_LOG_THRESHOLD')) {
            define('WPDesk\FlexibleSubscriptions\Vendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
