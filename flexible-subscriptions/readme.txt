...
– [Flexible Subscriptions Recurring Shipping](https://wpdesk.net/sk/flexible-subscriptions-rm-recurring) – manage shipping separately from billing cycles
– [Flexible Subscriptions Payment Retry](https://wpdesk.net/sk/flexible-subscriptions-rm-retry) – automatic retries and email notifications after failed payments
...
Find full documentation here → [**plugin documentation**](https://wpdesk.net/sk/flexible-subscriptions-rm-docs).
For support requests, please use the [**official plugin forums**](https://wordpress.org/support/plugin/flexible-subscriptions/) at WP.org.
If you need faster support, consider purchasing [**All Plugins Bundle**](https://wpdesk.net/sk/flexible-subscriptions-rm-bundle) to get more plugins and 1-on-1 priority email support.
...
Learn more about our [Use of Data Policy by WP Desk Plugins](https://wpdesk.net/sk/flexible-subscriptions-rm-privacy)
...
You can also read the [**plugin documentation**](https://wpdesk.net/sk/flexible-subscriptions-rm-docs).

= Do you provide support? =

Of course! Please use the [**official plugin forum**](https://wordpress.org/support/plugin/flexible-subscriptions/) at WP.org.
...
First, you may check out the [**documentation**](https://wpdesk.net/sk/flexible-subscriptions-rm-docs). Then, you can also read some articles about the plugin on the [**WP Desk's blog**](https://wpdesk.net/?s=flexible-subscriptions&utm_source=wporg&utm_medium=readme&utm_campaign=flexible-subscriptions&utm_content=blog).

You may check out the following article:

– [Subscriptions and recurring payments in WooCommerce (free)](https://wpdesk.net/sk/flexible-subscriptions-rm-rec-docs/)

= Is it possible to add custom fields for subscriptions? =

Yes. You can use [Flexible Product Fields  – a free product field customizer for WooCommerce](https://wordpress.org/plugins/flexible-product-fields/).

= Where do I report security bugs found in this plugin? =

Please report security bugs found in the source code of the Flexible Subscriptions plugin through the [Patchstack Vulnerability Disclosure  Program](https://patchstack.com/database/vdp/118f101c-cd17-4e11-8d26-30007df0f4a0). The Patchstack team will assist you with verification, CVE assignment, and notify the developers of this plugin.
...
* Fixed PHP 7.4 compatibility when creating subscriptions.
...
= 1.8.2 - 2026-08-11 =
* Fixed a critical cart error when using WooCommerce Tax with subscription products.
...
= 1.7.18 - 2026-06-24 =
* Fixed fatal error caused by incomplete subscription status update hook payloads during payment retry flows.
* Fixed past-due subscription recovery for legacy renewal orders missing renewal metadata.
* Added backfill for historical renewal order metadata used by subscription recovery.
* Improved recovery flow to restore the next payment schedule after a recovered renewal without automatically charging multiple missed periods.
...
= 1.7.13 - 2026-05-07 =
* Fixed subscription status update after expiration

= 1.7.12 - 2026-05-07 =
* Added support for WooCommerce 10.8

= 1.7.11 - 2026-04-22 =
* Fixed manual subscription creation

= 1.7.10 - 2026-04-21 =
* Fixed missing saving expiration date on subscription, when product has specified max billing cycles.
...
= 1.7.2 - 2026-01-15 =
* Fixed critical regression introduced in rare cases, when payment gateways and external plugins try to query multiple subscriptions with `wcs_get_subscriptions` function.
* Fixed issues in HPOS environments with comparing internal date structures during database writes.
* Improved compatibility with recent PHP versions >= 8.4.

= 1.7.1 - 2026-01-12 =
* Improved handling of payment gateways, ensuring compatibility with PayPal, Stripe and other major gateways.

= 1.7.0 - 2025-12-11 =
* Added Flexible Subscriptions REST API addon support

= 1.6.15 - 2025-12-10 =
* Fixed error with tax calculation rounding in block checkout.
* Added status update hooks with finer granularity: `fsub/subscription/status/changed/from/{old_status}/to/{new_status}` and `fsub/subscription/status/changed/to/{new_status}`.
